    ...
    return {
        ...
        css: function(styles) {
            if (styles.opacity !== null){
                if (typeof element.style.opacity !== 'string' && typeof(element.filters) !== 'indefinido'){
...
qq.FineUploaderBasic = function(o){
    ...
    this._options = {
        ...
        messages: {
            ...
            emptyError: "{file} esta vacío, favor de volver a seleccionar los archivos.",
            noFilesError: "No hay archivos.",
            onLeave: "Los archivos se están cargando, si abandonas la página la carga se cancelará."
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 3,
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        messages: {
            tooManyFilesError: "Sólo se puede arrastrar un archivo"
        },
        retry: {
            showAutoRetryNote: true,
            autoRetryNote: "Volviendo a intentar {retryNum}/{maxAuto}...",
            showButton: false
        },
