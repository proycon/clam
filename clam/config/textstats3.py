...
INPUTSOURCES = [
    InputSource(id='sampleinput',label='Sample input',path='/tmp/test.txt',defaultmetadata=PlainTextFormat(None, encoding='utf-8') ),
]
...
PROFILES = [
    Profile(
        InputTemplate('textinput', PlainTextFormat,"Input text document",
            ...
            InputSource(id='sampleinput',label='Sample input',path='/tmp/test.txt',metadata=PlainTextFormat(None, encoding='utf-8') ),
