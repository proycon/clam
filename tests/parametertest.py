...
class BooleanParameterTest(unittest2.TestCase):
    ...
    def setUp(self):
        self.parameter = clam.common.parameters.BooleanParameter('test','test','test')
    ...
    def test_set_true(self):
        """Setting Boolean parameter to True"""
    ...
    def test_set_false(self):
        """Setting Boolean parameter to False"""
...
class IntegerParameterTest(unittest2.TestCase):
    ...
    def setUp(self):
        self.parameter = clam.common.parameters.IntegerParameter('test','test','test',min=1,max=10)
...
class FloatParameterTest(unittest2.TestCase):
    ...
    def setUp(self):
        self.parameter = clam.common.parameters.FloatParameter('test','test','test',min=0.0,max=1.0)
...
class StringParameterTest(unittest2.TestCase):
    ...
    def setUp(self):
        self.parameter = clam.common.parameters.StringParameter('test','test','test',maxlength=10)
...
class ChoiceParameterTest(unittest2.TestCase):
    ...
    def setUp(self):
        self.parameter = clam.common.parameters.ChoiceParameter('test','test','test',choices=[('a','A'),('b','B'),('c','C')] )
...
class MultiChoiceParameterTest(unittest2.TestCase):
    ...
    def setUp(self):
        self.parameter = clam.common.parameters.ChoiceParameter('test','test','test',choices=[('a','A'),('b','B'),('c','C')], multi=True )
