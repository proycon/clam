...
\begin{verbatim}
        ...
        WSGIDaemonProcess yourservice user=proycon group=users home=/path/to/clam threads=2 maximum-requests=10000
...
Needless to say, all paths need to be adapted according to your setup and the configuration can be extended further as desired, with for example extra authentication or more restrictive access.
