...
{\bf \small version 0.8} \\ \vspace*{0.5cm}{\huge Documentation}\\
...
On the part of these users, a certain level of technical expertise is required and assumed, such as familiarity with UNIX/Linux systems and programming. 
...
The software is designed for Unix-based systems (e.g. Linux or BSD) only. It also has been verified to run on Mac OS X. Windows is not supported.
...
The following software is required to run CLAM, the \emph{easy install} process should obtain and install all of these dependencies automatically, except for Python itself:

\begin{itemize}
\item python 2.6 (or a higher 2.x version, 2.5 may also work but is less tested)
...
%Though the Python Package Index is the recommended way of installing and maintaining CLAM up to date nowadays. CLAM is hosted on github and  
