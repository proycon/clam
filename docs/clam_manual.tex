...
\item \textbf{I get an error loading stylesheet} -- The XSL stylesheet that
  ...
  alternative hostnames or IPs will not work. Browsers refuse to load stylesheets from other source for security reasons. Check your settings for HOST, PORT,  and URLPREFIX, and whether you accessed the service by the same URL.
...
needing authentication, allowing them to serve anonymous users. To do so, add
