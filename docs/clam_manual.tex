...
In order to run CLAM in Apache 2, you first need to install the mod_wsgi packafge for Apache. This offers an interface between Apache and Python. In Debian and Ubuntu, this package is available a  \texttt{libapache2-mod-wsgi}.
