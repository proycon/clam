...
{\bf \small version 0.8.2} \\ \vspace*{0.5cm}{\huge Documentation}\\
...
If you look in the directory where CLAM has been installed,tThe following files may be of particular interest:
...
The tool will create a directory named after the identifier, in which two template files are created which are similarly named after the chosen identifier. Both are Python scripts:
...
These template files need to be edited for your particular application. They are heavily commented to guide you. 
