...
Make sure the actual command is an absolute path or the executable is in the user's \textt{\$PATH}. Upon launch, the current working directory will be automatically set to the specific project directory.
