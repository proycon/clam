...
{\bf \small version 0.99.17$+$ - revision 1.4} \\[0.5cm]
{ \Large \bfseries Documentation}\\[0.5cm]
{\large \emph{Maarten van Gompel}}\\[0.5cm]
\HRule \\[1.0cm]

\emph{November 11th, 2014 (date published) - September 25th, 2015 (last revision)} \\[0.5cm] 
...
\textbf{URL} & \texttt{/} or \texttt{/entry/} \\ 
\hline
