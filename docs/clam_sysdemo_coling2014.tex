...
\title{CLAM: Quickly deploy NLP applications for the web}

\author{Maarten van Gompel \and Martin Reynaert\\ 
  Centre for Language Studies \\
  Radboud University Nijmegen \\
  {\tt proycon@anaproy.nl, reynaert@uvt.nl} }
...
practise in line with the UNIX philosophy \cite{unixphilo} which states,
