...
SYSTEM_DESCRIPTION = u"Frysk-Nederlânske oersetter / Fries-Nederlands vertaalsysteem"
...
PROFILES = [ 
    Profile(
        ...
        OutputTemplate('output-nl',PlainTextFormat,'Nederlandse vertaling / Nederlânske oersetting',
    ...
    Profile(
        InputTemplate('input-nl', PlainTextFormat,"Nederlandse tekst / Nederlânske tekst",  
            StaticParameter(id='encoding',name='Encoding',description='The character encoding of the file', value='utf-8'),  
            ChoiceParameter(id='language',name='Language',description='The language the text is in', choices=[('nl',u"Nederlânsk / Nederlands"),('fy','Frysk / Fries')]),
            #StringParameter(id='author',name='Author',description="The author's name", maxlength=100),
            #InputSource(id='sampledoc', label="Sample Document", path=ROOT+'/inputsources/sampledoc.txt', metadata=PlainTextFormat(None, encoding='utf-8',language='en')),
