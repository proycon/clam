...
#        encoding = inputfile.metadata['encoding']
        ...
        os.system("perl /home/tgaustad/work/implicit_linguistics/list_comparison.pl -l /home/tgaustad/work/implicit_linguistics/twente2002-martin-attested-errors-antal-tanja-corrections.txt -i " + str(inputfile) + " > /home/tgaustad/work/implicit_linguistics/INPUT.spellcorrectlist") 
